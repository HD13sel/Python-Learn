...
#Caso o get não encontre o objeto com a chave iformada, será retornado o valor None e não será gerado o KeyError.
pais = paises.get('py')
...
# Podemos definir um valor padão para caso não encontramos o objeto com a chave informada.
...
# Podemos utilizar qualquer tipo de dados (int, float, string, boolean, list, tuple, dict)
...
# 1 - Poderiamos utilizar lista para isso? Sim.
...
# 3 - Podreiamos utilziar dicionário para isso? Sim
...
# O método fromkeys recebe dois parâmetros: um iterável e um valor. //.fromkeys(chave,valor)//
