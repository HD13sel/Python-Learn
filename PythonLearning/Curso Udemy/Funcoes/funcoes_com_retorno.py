...
OBS: Em Python, quand uma função não retorna nenhum valor, o retorno é (None).

OBS: Funções Python que retornam valores, devem retornar estes valores com a palavra (return).
...
# Vamos criar um função para jogar a moeda (Cara/Coroa)

from random import random

def joga_moeda():
    # Gera um número pseud-randomico entre 0 e 1
    valor = random()
    if valor > 0.5:
        return 'Cara'
    return 'Coroa'
