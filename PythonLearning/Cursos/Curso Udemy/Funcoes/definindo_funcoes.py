...
é bom fazer uma verificação para que função seja simplificada
...
parametros_de_entrada -> Opcionais, onde tendo mais de um, cada um separado por (,), podendo ser opcionais ou não;
...
estamos definindo uma função. Também abrimos o bloco de código com o já conhecido (:) que é utilizado em Python 
para definir blocos.
"""
...
2 - Veja que nossa função só executa 1 tarefa;
