...
Se a gente pensar um função, já sabemos que temos funções que:
- Não possuem entrada;
- Não possuem saída;
...
# em uma função quantos parâmetros forem necessários. Eles são separados por (,)
...
# print(soma(2, 3, 4))  # TypeError - Argumento a mais
# print(soma(4))  # TypeError - Argumento a menos
...
print(nome_completo('Henrique', 'Diesel'))
...
print(nome_completo(nome='Henrique', sobrenome='Diesel'))
print(nome_completo(nome=nome, sobrenome=sobrenome))
print(nome_completo(nome='Henriq', sobrenome='Leseid'))
"""
