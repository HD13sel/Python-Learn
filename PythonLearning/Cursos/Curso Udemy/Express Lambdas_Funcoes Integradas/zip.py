...
# Sempre podemos gerar uma list, tuple, set ou dict.
...
# OBS: O zip() utiliza como param. o menor tamanho em iterável. Isso significa que se estiver
...
print(list(zip(*dados)))  # Desempacotando com *
"""
